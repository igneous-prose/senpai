...
def test_advisor_charter_explains_pr_comment_events():
    ...
    assert "`human_pr_comment` event" in instructions
    assert "verified GitHub owner, member, or collaborator" in instructions
    assert "`respond_to_human_issue` applies only to GitHub Issues" in instructions
