...
PAPER_DIR = SOURCE_DIR.parents[1]
...
def build_summary(
    ...
    summary: dict[str, Any] = {
        ...
        "repo": REPO,
        "outputs": {
            "points_csv": str(POINTS_CSV.relative_to(PAPER_DIR)),
            "interventions_csv": str(INTERVENTIONS_CSV.relative_to(PAPER_DIR)),
            "png": str(PNG_OUT.relative_to(PAPER_DIR)),
            "pdf": str(PDF_OUT.relative_to(PAPER_DIR)),
        },
        "labels": {},
    }
    for label in LABELS:
