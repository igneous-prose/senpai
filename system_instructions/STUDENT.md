...
- Do not mutate GitHub workflow state or push through shell commands. Use `submit_experiment_result` so the branch lease, result identity, draft state, and labels are verified together.
