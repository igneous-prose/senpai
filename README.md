...
- The advisor keeps one conversation UUID under the pod-local `/var/lib/senpai/<tag>/advisor/openhands_state`; it survives restarts. A new authenticated human instruction replaces a quarantined UUID while retaining its trace.
