...
\begin{table}[t]
  ...
  \begin{tabular}{@{}lrrr@{}}
    ...
    Method & $p_s$ & $\tau$ & $p_v$ \\
    \midrule
    SENPAI (ours) & \best{3.5634} & 6.5409 & \best{3.4014} \\
...
Across the five trials, SENPAI ran 9,591 tracked experiments total using 9,772 training GPU-hours on NVIDIA RTX PRO 6000 Blackwell 96GB GPUs, or 1,954 GPU-hours per trial on average. For comparison, Prime Intellect reports roughly 14k H200 GPU-hours over 10,428 released runs; 2,204 appear to be Claude Code runs and 8,224 Codex runs \citep{primeintellect2026autonanogpt}. Assuming equal run duration, this corresponds to about 3.0k H200 GPU-hours for Claude Code and 11.0k for Codex, or roughly 10.5 and 39.3 zettaFLOP, versus about 3.5 zettaFLOP for one average SENPAI trial (see \Cref{app:modded-nanogpt-details}).
...
For the compute comparison in \Cref{sec:results}, we use NVIDIA's published dense BF16/FP16 tensor throughput for RTX PRO 6000 Blackwell and H200 GPUs \citep{nvidia2025rtxpro6000blackwell,nvidia2026h200}. This gives a rough hardware-peak upper bound of about 3.5 zettaFLOP for one average SENPAI trial. Prime Intellect reports roughly 14k H200 GPU-hours across its autonomous nanoGPT speedrun. Of the 10,428 released runs, 2,204 are labeled Claude Code and 8,224 Codex; the Claude Code rows account for 18.6\% of logged training seconds. For the simpler comparison in the main text, we allocate GPU-hours by run count, equivalent to assuming equal run duration. This gives about 3.0k H200 GPU-hours for Claude Code and 11.0k for Codex, or about 10.5 and 39.3 zettaFLOP at dense H200 BF16/FP16 peak. These estimates use hardware peak throughput, not measured realized training FLOPs.
