...
The SENPAI harness is released at \url{https://github.com/wandb/senpai}. Public experiment ledgers are available through GitHub PR histories in \url{https://github.com/wandb/senpai}, \url{https://github.com/morganmcg1/tandemfoil2}, and \url{https://github.com/morganmcg1/TandemFoilSet-Balanced}, with W\&B run records under \url{https://wandb.ai/wandb-applied-ai-team/senpai-v1}, \url{https://wandb.ai/wandb-applied-ai-team/senpai-v1-drivaerml}, \url{https://wandb.ai/wandb-applied-ai-team/senpai-v1-drivaerml-ddp8}, and \url{https://wandb.ai/wandb-applied-ai-team/kagent-v2}. The CFD datasets used in the experiments are DrivAerML, AirfRANS, and TandemFoilSet; access and redistribution follow the licenses and terms provided by the original dataset authors.
