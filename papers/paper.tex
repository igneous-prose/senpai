...
\begin{table}[t]
  ...
  \begin{tabular}{@{}lrrr@{}}
    ...
    Method & $p_s$ & $\tau$ & $p_v$ \\
    \midrule
    Transolver-3 \citep{zhou2026transolver3} & \best{3.71} & \best{5.85} & \best{5.72} \\
...
\begin{table}[h]
  ...
  \begin{tabular}{@{}p{0.30\textwidth}p{0.62\textwidth}@{}}
    ...
    \href{https://wandb.ai/wandb-applied-ai-team/senpai-v1-drivaerml-ddp8}{\texttt{senpai-v1-drivaerml-ddp8}} & Eight-GPU DrivAerML follow-up runs for the selected recipe and ensemble records. \\
